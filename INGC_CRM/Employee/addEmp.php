                            ...
                            <div class="basic-form">
                                <form id="addemployeedata" method="post">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" placeholder="Last Name" name="nomEmploye">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="password" class="form-control" placeholder="Password" name="mdpEmploye">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" placeholder="Enter Your Phone Number" name="telEmploye">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="email" class="form-control" placeholder="E-mail" name="emailEmploye">
                                        </div>
                                    </div>
            ...
            <script>
                $(() => {
                    $('#addemployeedata').submit(function(e) {
                        ...
                        $.ajax({
                            url: baseUrl + "/employes/addEmploye/",
                            dataType: "json",
                            processData: false,
                            contentType: false,
                            type: 'POST',
